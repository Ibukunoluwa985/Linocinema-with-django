...
EMAIL_HOST_USER = 'linocinemaelnino@gmail.com' # replace this with your gmail account EMAIL e.g: (123@gmail.com)
EMAIL_HOST_PASSWORD = 'albelhrmlpkckeyh' # replace this with your gmail account PASSWORD e.g: (123abc)
EMAIL_PORT = 587
...
CKEDITOR_5_CONFIGS = {
    'default': {
        'toolbar': ['heading', '|', 'bold', 'italic', 'link',
                    'bulletedList', 'numberedList', 'blockQuote', 'imageUpload', 'removeFormat', ],
